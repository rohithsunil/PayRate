...
function changeCurr() {
    if(toggleButton.checked) {
        ...
        document.querySelector(".bitHide").classList.remove("hidden");
        document.querySelector(".payHide").classList.add("hidden");
    }
    else {
        document.querySelector(".bitHide").classList.add("hidden");
        document.querySelector(".payHide").classList.remove("hidden");
        document.querySelector(".bitHide1").classList.add("hidden");
        document.querySelector(".payHide1").classList.remove("hidden");
    ...
    for (let i = 0; i < dropList.length; i++) {
        if (!toggleButton.checked) {
            for(let currency_code in country_list) {
                ...
                let selected = i == 0 ? currency_code == "AED" ? "selected" : "" : currency_code == "INR" ? "selected" : "";
